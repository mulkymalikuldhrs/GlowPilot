      ...
      try {
        ...
        if (querySnapshot.empty) {
          ...
          const diagnosisSummary =
            lastConsultation.diagnosis?.diagnosis || 'masalah kulit umum';
    ...
    <Card className="w-full glass-card overflow-hidden flex flex-col">
      <CardContent className="p-0 flex flex-col flex-grow">
        ...
        <div className="p-4 space-y-2 flex flex-col flex-grow">
          <h3 className="font-bold text-sm leading-snug flex-grow">
            {product.title}
          </h3>
          <p className="text-sm text-muted-foreground font-semibold">
            {product.price}
          </p>
          <Button className="w-full text-primary-foreground bg-primary" asChild>
            <Link
        ...
        <Card className="glass-card mt-6">
          <CardContent className="p-6 flex flex-col items-center justify-center text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Mulai konsultasi pertama Anda dengan dokter AI untuk mendapatkan
              rekomendasi produk yang disesuaikan di sini.
            </p>
      ...
      return (
        <Card className="glass-card mt-6">
          <CardContent className="p-6 flex flex-col items-center justify-center text-center">
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Kami tidak dapat menemukan produk yang cocok saat ini. Silakan
              coba lagi nanti.
            </p>
          </CardContent>
        </Card>

...
/**
 * Higher-order function to get an API key dynamically from environment variables.
 * Supports comma-separated keys for rotation.
 * @param envVarName The name of the environment variable containing the API key(s).
 */

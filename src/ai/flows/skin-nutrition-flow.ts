...
import type {
  SkinNutritionInput,
  SkinNutritionOutput,
} from '@/ai/schemas/skin-nutrition-schemas';
import {
  SkinNutritionInputSchema,
  SkinNutritionOutputSchema,
} from '@/ai/schemas/skin-nutrition-schemas';

export async function getSkinNutritionAdvice(
  input: SkinNutritionInput
): Promise<SkinNutritionOutput> {

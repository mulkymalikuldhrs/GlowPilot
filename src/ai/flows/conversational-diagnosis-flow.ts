...
5.  **Provide Diagnosis & Goal (CRUCIAL):** When 'isComplete' is true, you MUST perform the following actions in order:
    a.  **Use Product Tool:** You MUST call the \`productCatalogTool\` to find 2-3 suitable products. Your search query for the tool should be concise and based on the primary skin issue (e.g., "acne serum", "gentle cleanser for sensitive skin", "anti-aging retinol moisturizer").

...
- **Completion:**
    ...
    3. Provide a brief, one-sentence \`routineAnalysis\` berdasarkan jawaban mereka (contoh: "Rutinitas Anda tampaknya bagus, tetapi mungkin kita bisa menambahkan perlindungan matahari." atau "Kurang tidur dan stres bisa jadi pemicu masalah kulit Anda.").

...
import type {
  AntiAgingInput,
  AntiAgingOutput,
} from '@/ai/schemas/anti-aging-schemas';
import {
  AntiAgingInputSchema,
  AntiAgingOutputSchema,
} from '@/ai/schemas/anti-aging-schemas';

export async function getAntiAgingAdvice(
  input: AntiAgingInput
): Promise<AntiAgingOutput> {

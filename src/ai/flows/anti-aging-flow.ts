...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI anti-aging specialist. Based on the user's age, skin type, concerns, and current routine, provide a comprehensive anti-aging plan.
...
Analyze the user's situation and provide a detailed, personalized AM and PM skincare routine. Suggest specific types of products (e.g., 'a vitamin C serum', 'a retinol cream'). Also, provide a list of key anti-aging ingredients to look for and some actionable lifestyle tips.`,
});

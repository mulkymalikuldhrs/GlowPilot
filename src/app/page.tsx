      ...
      <main className="flex-1">
        <section className="container mx-auto px-4 py-20 md:py-32 flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2 text-center md:text-left">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <Button size="lg" asChild style={{backgroundColor: 'var(--primary-optimistic)', color: 'white'}}>
                <Link href="/login">
        ...
        <section className="bg-secondary/50 py-20">
                    ...
                    {features.map((feature, index) => (
                        <div key={index} className="flex flex-col items-center gap-3">
                            <div className="flex items-center justify-center h-12 w-12 rounded-full bg-primary/10 text-primary">
                                <CheckCircle2 className="h-6 w-6" style={{color: 'var(--primary-optimistic)'}}/>
                            </div>
         ...
         <section className="container mx-auto px-4 py-20 md:py-32 text-center">
            ...
            <div className="mt-8">
                 <Button size="lg" asChild className="transform hover:scale-105 transition-transform" style={{backgroundColor: 'var(--primary-optimistic)', color: 'white'}}>
                    <Link href="/login">
